...
g++ -g -o test_reader test_videoReader.cpp video_reader.cpp  data_manager.cpp codeStreaming_parser.cpp bitrate_select.cpp  fec_param_adjustor.cpp path_selector.cpp myUtility.cpp  libRS_FFT.a -lpthread
